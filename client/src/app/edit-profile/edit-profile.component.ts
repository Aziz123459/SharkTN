...
export class EditProfileComponent {
  ...
  updateProfile():void{
    const data1={_id:this.user._id,firstName:this.user.firstName,lastName:this.user.lastName,phone:this.user.phoneNumber,address:this.user.Adress}
    ...
    if(this.type=="startup"){
      ...
      const data3={_id:this.dataInvestor._id,investmentAmount:this.dataInvestor.investmentAmount,message:this.dataInvestor.message}
